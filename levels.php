...
if(isset($_GET['a1/1/1'])) {
    ...
    echo 'We are moving out!';
	
} else if (isset($_GET['a2/4/1'])) {
    
    echo 'All about films!';
	
} else if (isset($_GET['a2/4/2'])) {
    
    echo 'Culture in my city';
	
} else if (isset($_GET['a2/5/1'])) {
    
    echo 'Sports and games';
